...
public class MyContacts {
  ...
  public static void main(String[] args) {
    ...
    // set a counter to 0; after the first loop, 
    // it will increment (to remove the menu)
    int counter = 0;
    ...
    while (continue_program) {
      ...
      if (counter == 0) {
        ...
        System.out.println("\t\tenter command> a, Sara Pethe, sara@bu.edu," +
                           " 617-353-9102");
        System.out.println("\t [d]elete: deletes a contact from the list " + 
                           "using the index number");
        System.out.println("\t\tenter command> d, 1");
        System.out.println("\t [s]earch: searches for a contact in the list " +
                           "using a string");
        System.out.println("\t\tenter command> s, Nathan");
        System.out.println("\t [e]mail: searches for a contact in the list " + 
                           "using a string");
      ...
      // based on the command, the rest of the user's input 
      // will be used in various ways
      switch (control) {
        // if A or a
        case 'A':
        case 'a':
        ...
        case 'e': 
          ...
          if (command_parts.length == 2) {
            ...
            contact_list.searchContacts(control, command_parts[1].trim());          
          }
          // otherwise
          else {
            // say the command is unknown
        ...
        case 'w': 
          ...
          if (command_parts.length == 2) {
            ...
            contact_list.writeToFile(command_parts[1].trim());
          }
          // otherwise
          else {
            // say the command is unknown
        ...
        case 'r': 
          ...
          if (command_parts.length == 2) {
            ...
            contact_list.restoreFromFile(command_parts[1].trim());
          }
          // otherwise
          else {
            // say the command is unknown
