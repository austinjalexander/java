...
// Fig. 8.17: MyRectangle.java
// MyRectangle class represents a rectangle.
...
public class MyRectangle {
  ...
  public MyRectangle(int x1, int y1, int x2, int y2, Color color, boolean fill_flag) {
